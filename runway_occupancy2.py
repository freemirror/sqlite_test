...
FORMAT = '%Y-%m-%d %H:%M:%S'
CITIES = ['Джакарта', 'Баку', 'Мельбурн', 'Париж', 'Берлин', 'Вашингтон', 'Каир',
          'Будапешт']

PLANES = ['Airbus A220', 'Airbus A310', 'Airbus A320', 'Airbus A330',
          'Airbus A340', 'Airbus A350', 'Airbus A380', 'Боинг-717',
          'Боинг-737', 'Боинг-747', 'Боинг-757', 'Боинг-767', 'Боинг-777',
          'Боинг-787', 'ATR 42/72', 'Bae Avro RJ', 'Bombardier Dash 8',
          'Bombardier CRJ', 'Embraer ERJ', 'Embraer 170/190', 'Saab',
          'Суперджет-100', 'Туполев Ту-204', 'Ильюшин Ил-96', 'Ильюшин Ил-114',
          'Антонов Ан-38', 'Антонов Ан-140', 'Антонов Ан-148']
